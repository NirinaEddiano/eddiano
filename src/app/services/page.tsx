...
export default function ServicesPage() {
  ...
  return (
    <main className="bg-white">
              ...
              <div key={index} className={`flex flex-col lg:flex-row items-center gap-16 ${index % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                ...
                >
                  <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100">
                    <img src={service.img} alt={service.title} className="w-full h-[500px] object-cover hover:scale-105 transition-transform duration-700" />
                ...
                <div className="w-full lg:w-1/2 space-y-10">
                  <div>
                    ...
                    <h2 className="text-4xl font-black text-gray-900 mt-2 mb-6 leading-tight">L'approche <br/> {service.title}</h2>
                  </div>
                  ...
                  <Link href="/devis" className="inline-flex items-center gap-4 bg-gray-900 text-white px-8 py-4 rounded-full font-bold hover:bg-blue-600 transition-all group">
      ...
      <section className="py-28 bg-gray-900 overflow-hidden relative">
          <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="relative order-2 lg:order-1">
                  ...
                  <div className="relative h-[450px] w-full">
                      <motion.img 
                        ...
                        src="/assets/projects/p1-pc.jpg" className="absolute top-0 left-0 w-2/3 rounded-2xl shadow-2xl border border-white/10 z-20" alt="Work 1" 
                      />
                      <motion.img 
                        animate={{ y: [0, 20, 0] }} transition={{ duration: 5, repeat: Infinity }}
                        src="/assets/projects/p2-mobile.jpg" className="absolute bottom-10 right-0 w-1/3 rounded-2xl shadow-2xl border border-white/10 z-30" alt="Work 2" 
                      />
              ...
              <div className="text-white space-y-8 order-1 lg:order-2">
                  <h2 className="text-4xl md:text-5xl font-black leading-tight">Nos résultats parlent <br/> <span className="text-blue-400">plus fort que les mots.</span></h2>
                  ...
                  <Link href="/realisations" className="inline-flex items-center gap-3 px-10 py-5 bg-white text-black rounded-full font-black hover:scale-105 transition-transform">
        ...
        <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold mb-4">Une question technique ?</h2>
                ...
                <div className="space-y-4 mb-20">
                    {[
                        ...
                        <div key={i} className="bg-white rounded-3xl border border-gray-100 overflow-hidden">
                            <button onClick={() => setActiveFaq(activeFaq === i ? null : i)} className="w-full flex justify-between items-center p-8 text-left font-bold text-gray-900">
                ...
                {/* CONTACT CTA CARD */}
                <div className="bg-white p-10 rounded-[3rem] border-2 border-dashed border-gray-200 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
                    <div>
                    ...
                    <Link href="/contact" className="flex items-center gap-3 bg-blue-600 text-white px-8 py-4 rounded-2xl font-bold hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/20">
